<template>
  <div class="relative flex items-center justify-center overflow-hidden py-20 sm:py-28" :style="{ '--streak-speed': streakSpeed }" @mouseover="fast = true" @mouseleave="fast = false">
    <span
      v-for="n in 5"
      :key="n"
      :style="{
