<template>
  <div>
    <div id="Home" class="my-24 grid max-w-7xl gap-16 sm:grid-cols-2 sm:gap-y-24 lg:items-center">
      <div>
        <h1 class="mb-5 max-w-sm text-5xl font-bold lg:text-6xl lg:tracking-tight">Skateshop</h1>
        <p class="max-w-sm text-xl text-gray-400">Discover the world on Skateboard.</p>
